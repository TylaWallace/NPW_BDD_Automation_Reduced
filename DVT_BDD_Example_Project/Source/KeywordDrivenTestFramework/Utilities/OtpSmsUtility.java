...
public class OtpSmsUtility extends BaseClass {
    ...
    public boolean waitForCloseImage() {
        if (!SeleniumDriverInstance.waitForElementByXpath(closeBtnClass)) {
            return false;
        }
        return true;
    }
    ...
    public boolean clickClose() {
        if (!SeleniumDriverInstance.clickElementbyXpath(closeBtnClass)) {
            return false;
        }
        return true;
    }
    ...
    public boolean waitForSignInHead() {
        if (!SeleniumDriverInstance.waitForElementByXpath(airdroidHeadClass)) {
            return false;
        }
        return true;
    }
    ...
    public boolean enterAccount() {
        ...
        if (!SeleniumDriverInstance.enterTextByXpath(accountTextBoxClass, this.username)) {
    ...
    public boolean enterPassword() {
        if (!SeleniumDriverInstance.enterTextByXpath(passwordTextBoxClass, this.password)) {
            return false;
        }
        return true;
    }
    ...
    public boolean waitForAirdroidToLoad() {
        if (!SeleniumDriverInstance.waitForElementNoLongerPresentByXpath(airdroidHeadClass)) {
            return false;
        }
